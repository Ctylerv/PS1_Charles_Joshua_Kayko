...
The estimates for $\beta_1$ and $\beta_2$ are not biased, as the estimates are normally distributed about their specified values (as can be seen from the method of data generation above). 
